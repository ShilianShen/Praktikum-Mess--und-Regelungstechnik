...
\begin{figure}[htbp]
  ...
  \caption{固定固有频率 $\omega_n=\sqrt{3}$、改变阻尼系数 $D$ 时 PT2 环节的阶跃响应}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../figures/V2_2.pdf}
  \caption{固定阻尼系数 $D=\frac{1}{3}$、改变固有频率 $\omega_n$ 时 PT2 环节的阶跃响应}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{固定固有频率、改变阻尼系数时 PT2 环节的 Bode 图}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../figures/V4_2.pdf}
  \caption{固定阻尼系数、改变固有频率时 PT2 环节的 Bode 图}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{固定固有频率、改变阻尼系数时 PT2 环节的零极点图}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../figures/V5_2.pdf}
  \caption{固定阻尼系数、改变固有频率时 PT2 环节的零极点图}
\end{figure}
