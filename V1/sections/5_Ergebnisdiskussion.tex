...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V1_step.pdf}
    \caption{阶跃输入下的响应}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V1_sin.pdf}
    \caption{正弦输入下的响应}
  \end{subfigure}
  \caption{P、I、PT1 和 PT2 环节在不同输入信号下的输出比较}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V2_2.pdf}
    \caption{改变固有频率 $\omega_n$}
  \end{subfigure}
  \caption{PT2 环节阶跃响应比较：左图固定 $\omega_n=\sqrt{3}$，右图固定 $D=\frac{1}{3}$}
\end{figure}
...
\begin{itemize}
  ...
  \item 由于 $D$ 不变，相对超调趋势基本保持一致，但时间尺度随 $\omega_n$ 改变。
\end{itemize}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V4_1.pdf}
    \caption{改变阻尼系数 $D$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V4_2.pdf}
    \caption{改变固有频率 $\omega_n$}
  \end{subfigure}
  \caption{PT2 环节 Bode 图比较：左图固定固有频率，右图固定阻尼系数}
\end{figure}
...
当 $D \geq 1$ 时，共振峰基本消失，幅值曲线表现为单调下降。
这与阶跃响应中无超调或无振荡的现象一致。
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V5_1.pdf}
    \caption{改变阻尼系数 $D$}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{../figures/V5_2.pdf}
    \caption{改变固有频率 $\omega_n$}
  \end{subfigure}
  \caption{PT2 环节零极点图比较：左图固定固有频率，右图固定阻尼系数}
\end{figure}
